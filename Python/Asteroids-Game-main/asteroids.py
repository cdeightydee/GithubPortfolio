...
class Asteroids():
    ...
    def createRocks(self, numRocks):
        for _ in range(0, numRocks):
            position = pygame.Vector2(random.randrange(-10, 10),
        ...
        for rock in self.rockList:
            ...
            if rockHit:
                ...
                if rock.rockType != Rock.smallRockType:
                    # new rocks
                    for _ in range(0, 2):
                        position = pygame.Vector2(rock.position.x, rock.position.y)
    ...
    def createDebris(self, sprite):
        for _ in range(0, 25):
            position = pygame.Vector2(sprite.position.x, sprite.position.y)
